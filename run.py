...
# from exp.exp_long_term_forecasting_ICML import Exp_Long_Term_Forecast
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,  default='MPDNet', 
                        help='model name, options: [Autoformer, Transformer, MPDNet]')
    # add
    parser.add_argument('--use_revin', type=bool, default=True, help='use revin or not')    
    parser.add_argument('--period', type=int, default=[96, 8, 6, 24, 12], help='patch length')
    parser.add_argument('--k', type=int, default=5, help='period num')
    parser.add_argument('--patch_len', type=int, default=16, help='patch length')
    parser.add_argument('--kernel_list', type=int, default=[3, 7, 11], help='patch length')
